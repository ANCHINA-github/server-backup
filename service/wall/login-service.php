...
<head>
    ...
    <meta name="keywords" content="武冈十中服务平台,校园服务,班级墙,教师墙,考试预报,匿名聊天,校方通知">
    <meta name="description" content="武冈十中信息墙提供校园生活服务、信息发布、匿名聊天、考试预报等功能。">
    <meta name="author" content="305运营团队">
    <link rel="shortcut icon" href="/logo.png">
    <title>武冈信息墙 | 武冈十中墙</title> 
...
<body>
        ...
        <div class="modal-content">
            ...
            <div class="modal-scrollable">  
                ...
                <form id="postForm" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="postContent">武冈十中墙</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-scrollable">
                <form id="commentForm" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="commentContent">武冈十中墙</label>
    ...
    <div class="container" >
        ...
        <div id="section1">
            <div class="section1-top">
                <div class="logo-area">
                    ...
                    <div class="service-name">武冈十中墙</div>
                </div>
                <div class="nav-right">
        ...
        <div id="section3">
            ...
            <div class="service-button" onclick="location.href='#'">
                <div class="service-icon">
                    <i class="fas fa-chalkboard-teacher"></i>
            </div>
                <div class="service-text">教师联系表</div>
            </div>
            ...
            <div class="service-text">反馈问题</div>
              ...
              <div class="service-button" onclick="location.href='#'">
                ...
                <div class="service-text">线上泡面</div>
            </div>
        </div>
        ...
        <div id="section1_5">
            ...
            <button class="tab-button" id="loveTab">表白区</button>
            <button class="tab-button" id="gossipTab">八卦区</button>
        </div>
        ...
        <div id="section5">
            <div class="footer-logo-area">
                ...
                <div class="footer-service-name">武冈十中墙 | 305</div>
            </div>
        </div>
    </div>
